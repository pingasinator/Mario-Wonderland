...
extern unsigned char T_Castle_Ground_2[];
extern unsigned char T_Castle_Ground_3[];
extern unsigned char T_Castle_Ground_4[];
extern unsigned char T_Castle_Ground_5[];
extern unsigned char T_Castle_Ground_6[];
extern unsigned char T_Castle_Ground_7[];
extern unsigned char T_Castle_Ground_8[];
extern unsigned char T_Castle_Ground_9[];
extern unsigned char T_Castle_Ground_10[];
extern unsigned char T_Castle_Ground_11[];
extern unsigned char T_Castle_Ground_12[];
extern unsigned char T_Castle_Ground_13[];
extern unsigned char T_Castle_Ground_14[];
extern unsigned char T_Castle_Ground_15[];
extern unsigned char T_Castle_Ground_16[];

extern  unsigned char T_Castle_Background_0[];
extern  unsigned char T_Castle_Background_1[];
extern  unsigned char T_Castle_Background_2[];
extern  unsigned char T_Castle_Background_3[];
extern  unsigned char T_Castle_Background_4[];
extern  unsigned char T_Castle_Background_5[];
