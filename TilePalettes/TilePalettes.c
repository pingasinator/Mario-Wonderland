...
extern unsigned char T_Overworld_background_0[];
extern unsigned char T_Overworld_background_1[];
extern unsigned char T_Overworld_background_2[];
extern unsigned char T_Overworld_background_3[];
extern unsigned char T_Overworld_background_4[];
extern unsigned char T_Overworld_background_5[];
extern unsigned char T_Overworld_background_6[];
extern unsigned char T_Overworld_background_7[];
extern unsigned char T_Overworld_background_8[];
extern unsigned char T_Overworld_background_9[];
extern unsigned char T_Overworld_background_10[];
extern unsigned char T_Overworld_background_11[];
extern unsigned char T_Overworld_background_12[];
extern unsigned char T_Overworld_background_13[];
extern unsigned char T_Overworld_background_14[];
extern unsigned char T_Overworld_background_15[];
...
extern unsigned char T_Overworld_Ground_17[];
extern unsigned char T_Overworld_Ground_18[];
...
const unsigned char *Overworld_Background_Palette[] = 
{
    ...
    T_Overworld_background_0,T_Overworld_background_1,T_Overworld_background_2,T_Overworld_background_3,T_Overworld_background_4,T_Overworld_background_5,T_Overworld_background_6,T_Overworld_background_7,
    T_Overworld_background_8,T_Overworld_background_9,T_Overworld_background_10,T_Overworld_background_11,T_Overworld_background_12,T_Overworld_background_13,T_Overworld_background_14,T_Overworld_background_15
};
...
const unsigned char *Overworld_Ground_Palette[] = 
{
    ...
    T_Pipe_V_DL,T_Pipe_V_DR,T_Pipe_H_UL,T_Pipe_H_DL,T_Pipe_H_DR,T_Pipe_H_UR,T_Overworld_Ground_0,T_Overworld_Ground_1,T_Overworld_Ground_2,T_Overworld_Ground_3,T_Overworld_Ground_4,T_Overworld_Ground_5,
    T_Overworld_Ground_6,T_Overworld_Ground_7,T_Overworld_Ground_8,T_Overworld_Ground_9,T_Overworld_Ground_10,T_Overworld_Ground_11,T_Overworld_Ground_12,T_Overworld_Ground_13,T_Overworld_Ground_14,
    T_Overworld_Ground_15,T_Overworld_Ground_16,T_Overworld_Ground_17,T_Overworld_Ground_18
};
...
const unsigned char *Underground_Ground_Palette[] = 
{
    ...
    T_Alt_Block,T_Used_Block,T_Pipe_V_UL,T_Pipe_V_UR,T_Pipe_V_ML,T_Pipe_V_MR,T_Pipe_V_DL,T_Pipe_V_DR,T_Pipe_H_UL,T_Pipe_H_DL,T_Pipe_H_MU,T_Pipe_H_MD,T_Pipe_H_DR,T_Pipe_H_UR,T_Pipe_V_UL,T_Pipe_V_UR,
    T_Pipe_V_DL,T_Pipe_V_DR,T_Pipe_H_UL,T_Pipe_H_DL,T_Pipe_H_DR,T_Pipe_H_UR,T_Cloud,T_Underground_Ground_0,T_Underground_Ground_1,T_Underground_Ground_2,T_Underground_Ground_3,T_Underground_Ground_4,
    T_Underground_Ground_5,T_Underground_Ground_6,T_Underground_Ground_7,T_Underground_Ground_8,T_Underground_Ground_9,T_Underground_Ground_10,T_Underground_Ground_11,T_Underground_Ground_12,T_Underground_Ground_13
    ,T_Underground_Ground_14,T_Underground_Ground_15,T_Underground_Ground_16
};

const unsigned char *Underground_Background_Palette[] = 
{
    T_null,T_Grey_Light,T_Grey_Dark,T_Black,T_Coin,T_Hidden_Coin,T_Water_Top,T_Grey_Light,T_Lava_Top,T_Grey_Dark,T_End_Background,T_End_Block_UL,T_End_Block_UR,T_End_Block_DL,T_End_Block_DR,
