...
extern unsigned char T_Underground_Background_0[];
extern unsigned char T_Underground_Background_1[];
extern unsigned char T_Underground_Background_2[];
extern unsigned char T_Underground_Background_3[];
extern unsigned char T_Underground_Background_4[];
extern unsigned char T_Underground_Background_5[];
extern unsigned char T_Underground_Background_6[];
extern unsigned char T_Underground_Background_7[];
extern unsigned char T_Underground_Background_8[];
extern unsigned char T_Underground_Background_9[];
extern unsigned char T_Underground_Background_10[];
extern unsigned char T_Underground_Background_11[];
...
const unsigned char *Underground_Background_Palette[] = 
{
    ...
    T_Underground_Background_0,T_Underground_Background_1,T_Underground_Background_2,T_Underground_Background_3,T_Underground_Background_4,T_Underground_Background_5,T_Underground_Background_6,
    T_Underground_Background_7,T_Underground_Background_8,T_Underground_Background_9,T_Underground_Background_10,T_Underground_Background_11
};
...
const unsigned char *Underground_Ground_Palette[] = 
{
    ...
    T_Pipe_V_Head_L,T_Pipe_V_Head_R,T_Pipe_H_Head_U,T_Pipe_H_Head_D,T_Pipe_H_Head_D,T_Pipe_H_Head_U,T_Pipe_V_Head_L,T_Pipe_V_Head_R,T_Pipe_V_Head_L,T_Pipe_V_Head_R,T_Pipe_H_Head_U,T_Pipe_H_Head_D,T_Pipe_H_Head_D,T_Pipe_H_Head_U,T_Underground_Ground_0,T_Underground_Ground_1,T_Underground_Ground_2,T_Underground_Ground_3,T_Underground_Ground_4,
